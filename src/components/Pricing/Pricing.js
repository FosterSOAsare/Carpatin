...
const Pricing = () => {
	...
	return (
		<Box sx={{ width: "100%", height: "auto", background: theme.palette.background3.main, paddingBlock: "70px 120px" }}>
				...
				<Box sx={{ display: "flex", gap: "20px", width: "100%", justifyContent: "space-between", marginBottom: "50px" }}>
					{pricings.values.map((pricing, pricing_index) => (
						<Box
							...
							<Button sx={{ marginInline: "auto", marginTop: "10px", display: "block", textTransform: "none", padding: "10px" }} variant="text" color="secondary">
								Purchase Now
							</Button>
						</Box>
					))}
